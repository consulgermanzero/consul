...
ActiveRecord::Schema.define(version: 20210218195121) do
  ...
  create_table "site_customization_content_blocks", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string   "key"
    t.index ["key", "name", "locale"], name: "locale_key_name_index", unique: true, using: :btree
  end
  ...
  create_table "tags", force: :cascade do |t|
    ...
    t.index ["legislation_processes_count"], name: "index_tags_on_legislation_processes_count", using: :btree
    t.index ["legislation_proposals_count"], name: "index_tags_on_legislation_proposals_count", using: :btree
